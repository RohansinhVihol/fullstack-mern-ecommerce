...
const Add = ({token}) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(backendUrl + '/api/v1/product/add', formData,{headers:{token}})
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <button className='w-20 py-2 mt-4 bg-black text-white' type='submit'>ADD</button>
